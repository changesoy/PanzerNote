...
class MenuBuilder:
    ...
    def _build_view_menu(self, menubar: QMenuBar, mw: Any) -> None:
        ...
        menu.addSeparator()
        self._add_action(menu, "水平分屏", None, mw._split_editor_horizontal, "view.split_horizontal", "视图")
        self._add_action(menu, "垂直分屏", None, mw._split_editor_vertical, "view.split_vertical", "视图")
