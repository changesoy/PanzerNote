...
class MarkdownPreviewWidget(QWidget):
    ...
    def __init__(self, config: Config, parent=None):
        ...
        self._code_blocks = []  # 当前文档的代码块原始文本
        self._base_path = ""    # v1.5.5: 文件所在目录，用于解析本地图片路径
    ...
    def _update_preview(self):
        ...
        if HAS_WEBENGINE:
            # QWebEngineView 可使用 baseUrl 直接解析相对路径
            if self._base_path:
    ...
    def _render_markdown(self, text: str) -> str:
        ...
        if HAS_MARKDOWN_IT:
            try:
                ...
                # 尝试加载 mdit-py-plugins 中的扩展（def_list 等）
                try:
