...
_DEFAULT_SHORTCUTS = {
    ...
    "edit.insert_image": ("插入图片", "Ctrl+Shift+I", "工具"),
    "edit.recover_images": ("恢复缺失的图片", "", "工具"),
    "edit.cleanup_orphan_images": ("清理未使用的图片", "", "工具"),
    "edit.toggle_task": ("切换任务勾选", "Ctrl+Alt+T", "工具"),
    "edit.format_bold": ("加粗", "Ctrl+Alt+B", "工具"),
    "edit.format_italic": ("斜体", "Ctrl+Alt+I", "工具"),
    "edit.format_code": ("行内代码", "Ctrl+Alt+`", "工具"),
    "edit.format_link": ("插入链接", "Ctrl+Alt+K", "工具"),
    "edit.heading_1": ("一级标题", "Ctrl+Alt+1", "工具"),
    "edit.heading_2": ("二级标题", "Ctrl+Alt+2", "工具"),
    "edit.heading_3": ("三级标题", "Ctrl+Alt+3", "工具"),
    "edit.heading_4": ("四级标题", "Ctrl+Alt+4", "工具"),
    "edit.heading_5": ("五级标题", "Ctrl+Alt+5", "工具"),
    "edit.heading_6": ("六级标题", "Ctrl+Alt+6", "工具"),
    "edit.heading_clear": ("清除标题", "Ctrl+Alt+0", "工具"),
    "edit.table_insert_row_above": ("表格：在上方插入行", "", "工具"),
    "edit.table_insert_row_below": ("表格：在下方插入行", "", "工具"),
    "edit.table_delete_row": ("表格：删除当前行", "", "工具"),
    "edit.table_insert_column_left": ("表格：在左侧插入列", "", "工具"),
    "edit.table_insert_column_right": ("表格：在右侧插入列", "", "工具"),
    "edit.table_delete_column": ("表格：删除当前列", "", "工具"),
    "edit.table_format_align": ("表格：格式化对齐", "", "工具"),
    "edit.table_align_left": ("表格：左对齐当前列", "", "工具"),
    "edit.table_align_center": ("表格：居中当前列", "", "工具"),
    "edit.table_align_right": ("表格：右对齐当前列", "", "工具"),
    ...
    "tools.migrate_legacy_assets": ("迁移旧图片目录...", "", "工具"),
}
