...
_DEFAULT_SHORTCUTS = {
    ...
    "edit.heading_1": ("标题 1", "Ctrl+Alt+1", "编辑"),
    "edit.heading_2": ("标题 2", "Ctrl+Alt+2", "编辑"),
    "edit.heading_3": ("标题 3", "Ctrl+Alt+3", "编辑"),
    "edit.heading_4": ("标题 4", "Ctrl+Alt+4", "编辑"),
    "edit.heading_5": ("标题 5", "Ctrl+Alt+5", "编辑"),
    "edit.heading_6": ("标题 6", "Ctrl+Alt+6", "编辑"),
